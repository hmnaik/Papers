...
%\centering
%\begin{tabular}{cc}
%\bmvaHangBox{\fbox{\includegraphics[width=0.50\hsize]{images/Problem.pdf}} }&
%\bmvaHangBox{\fbox{\includegraphics[width=0.25\hsize]{images/carModels.pdf}} } \\ %keepaspectratio=true
%(a)&(b)
%\end{tabular}
...
%The centre recovery is prone to higher errors with higher camera distances, however it produces a consistent solution for invariant $ d_c $. 
