...
%Conic theory suggests that an elliptical image projection of a circle can be used to define the circle plane orientation in camera frame with an ambiguity. 
%encapsulate these invariants in
